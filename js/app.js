/* ============================================================================
   app.js — Orchestration de l'écran de saisie (lot 3).

   Enchaîne : porte d'authentification (Supabase Auth) → chargement des
   contrats actifs → écran de saisie du mois courant. Ne parle pas au réseau
   directement (tout via DB) et ne calcule rien (le moteur intervient au lot 4).
   ========================================================================= */
(function (global) {
  'use strict';
